    ...
    rsx! {
        div {
            ...
            input {
                ...
                value: "{props.value}",
                oninput: move |evt| {
                    props.value.set(evt.value().clone());
                },
                onchange: move |evt| {
                    props.value.set(evt.value().clone());
                },
                onfocusout: move |_| validate.set(true),
    ...
    T: Clone + PartialEq + Searchable + 'static,
{
    ...
    let _ = use_memo(move || selected_index.set(0));
    ...
    let _ = use_memo(move || {
        if select_value() {
            ...
            props.value.set(Some(result.clone()));
            props.search_expression.set("".to_string());
            props.search_results.set(vec![]);
            ...
            label {
                ...
                button {
                    ...
                    onclick: move |_| {
                        ...
                        dropdown_opened.set(!(*dropdown_opened)());
                    },
                    onfocus: move |_| {
                ...
                ul {
                    ...
                    li {
                        ...
                        input {
                            ...
                            autocomplete: "off",
                            oninput: move |evt| {
                                props.search_expression.set(evt.value().clone());
                            },
                            autofocus: props.autofocus.unwrap_or_default(),
                        }
                        Icon {
...

                    {
                        ...
                        search_results.into_iter().enumerate().map(|(i, result)| {
                            rsx! {
                                SearchResultRow {
                                    key: "{result.get_id()}",
